...
export class EditarProveedorComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<EditarProveedorComponent>,private proveedorService: ProveedorService,
  ...
  checkCedulaExists() {
    ...
    if (cedulaControl && this.proveedoresList.length > 0) {
      ...
      const cedulaExists = this.proveedoresList.some(proveedor => proveedor.identifier === identifier);
